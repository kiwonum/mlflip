...
public:    
	...
	PYTHON() void clear();
	PYTHON() void killOutOfDomain(const FlagGrid& flags, const int bnd=0);
	PYTHON() void killRegion(const FlagGrid& flags, const int target);
	PYTHON() void killSelected(const ParticleDataImpl<int> &ptype, const int select);

	//! insert particles by sampling "parts"
	PYTHON() int sampleFrom(const ParticleSystem &parts, const ParticleDataImpl<int> &ptype, const int select, const bool reset=false);
	...
	PYTHON() void getAtFromFlagGrid(ParticleDataImpl<int> &v, const FlagGrid &flags, const Vec3 offset=Vec3(0.), const ParticleDataImpl<int> *ptype=NULL, const int exclude=0) const;
	PYTHON() void getInterpolatedFromMACGrid(ParticleDataImpl<Vec3> &v, const MACGrid &grid, const Vec3 offset=Vec3(0.), const ParticleDataImpl<int> *ptype=NULL, const int exclude=0) const;
	PYTHON() void getInterpolatedFromGrid(ParticleDataImpl<Real> &v, const Grid<Real> &grid, const Vec3 offset=Vec3(0.), const ParticleDataImpl<int> *ptype=NULL, const int exclude=0) const;
	PYTHON() void getInterpolatedFromVecGrid(ParticleDataImpl<Vec3> &v, const Grid<Vec3> &grid, const Vec3 offset=Vec3(0.), const ParticleDataImpl<int> *ptype=NULL, const int exclude=0) const;
...
public:
	...
	PYTHON() void setConstIntFlag(const T &s, const ParticleDataImpl<int> &t, const int itype);
	//! special, set values serially from the given point "begin" with selected values from "s" using "t" & "select"
	PYTHON() void setValuesRangeSelected(const ParticleDataImpl<T> &s, const ParticleDataImpl<int> &t, const int select, const int begin);
